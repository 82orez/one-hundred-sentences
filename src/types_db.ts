...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      WaitForPurchase: {
        Row: {
          ...
          id: string
          startDate: string
          status: Database["public"]["Enums"]["WaitForPurchaseStatus"]
          totalFee: number
          updatedAt: string
          userId: string
          userName: string
        ...
        Relationships: [
          {
            foreignKeyName: "WaitForPurchase_courseId_fkey"
            columns: ["courseId"]
            isOneToOne: false
            referencedRelation: "Course"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "WaitForPurchase_userId_fkey"
            columns: ["userId"]
            isOneToOne: false
            referencedRelation: "User"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      Subject: "en" | "ja" | "ko" | "zh"
      WaitForPurchaseStatus: "pending" | "paid" | "cancelled" | "expired"
    }
    CompositeTypes: {
      [_ in never]: never
    }
