...
export default async function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-400 px-4 text-white md:px-6">
      <header className="mb-3 pt-5 text-center md:mb-10 md:pt-0">
        <h1 className="mb-4 text-3xl font-bold drop-shadow-lg md:mb-8 md:text-5xl">한 달만에 끝내는 “여행영어 100문장 사관학교”</h1>
