  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-blue-600 to-indigo-400 text-white">
      ...
      <header className="mb-8 px-4 pt-8 text-center md:mb-12 md:pt-12">
        <h1 className="mb-3 text-3xl font-bold drop-shadow-lg md:mb-8 md:text-5xl">프렌딩 영어 공동체에 오신 것을 환영합니다!</h1>
      ...
      <div className="w-full px-4 md:px-8">
        <Card className="mx-auto flex w-full max-w-4xl flex-col items-center rounded-2xl bg-white p-6 text-gray-800 shadow-xl md:flex-row">
          ...
          <CardContent className="text-center md:text-left">
            ...
            <p className="mb-1 text-gray-600">같이 배우고, 같이 말해보는 프렌딩 영어 공동체에 참여해보세요!</p>
            <p className="text-gray-600 md:mb-6">반드시 필요한 영어 100문장을 '함께' 완성하며 영어의 기초를 완성하세요.</p>
            ...
            <div className={"hidden md:flex md:w-full md:flex-col md:items-center"}>
              <div className={"hidden w-full md:flex md:max-w-[400px] md:flex-col md:items-center md:justify-between md:gap-4"}>
                <div className={"flex justify-center md:w-full md:justify-between md:gap-6"}>
                  <CultureMemberButton className="hidden cursor-pointer items-center rounded-xl bg-indigo-600 px-6 py-4 text-lg text-white hover:bg-indigo-700 md:flex md:w-[190px] md:gap-0">
